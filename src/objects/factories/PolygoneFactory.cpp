...
Polygone *PolygoneFactory::createPolygone(std::string type, Point &p, double size1, double size2, double size3, double size4, double alpha, double beta, double gama, const Color &color)
{
    if (type == "Cube"){
...
Polygone *PolygoneFactory::create1NEdron(Point &p, int precision, double height, double r, double alpha, double beta, double gama, const Color &color)
{
...
Polygone *PolygoneFactory::create2NEdron(Point &p, int precision, double height, double r, double alpha, double beta, double gama, const Color &color)
{
...
Polygone *PolygoneFactory::createParallelepiped(Point &p, double height, double width, double length, double alpha, double beta, double gama, const Color &color)
{
...
Polygone *PolygoneFactory::createDiamond(Point &p, double h, double H, double r, double R, double alpha, double beta, double gama, const Color &color)
{
...
Polygone *PolygoneFactory::createTape(Point &p, double R, double width, int precision, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
...
Polygone *PolygoneFactory::createClosedTape(Point &p, double R, double width, int precision, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
...
Polygone *PolygoneFactory::createMobiusTape(Point &p, double R, double width, int precision, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
...
Polygone *PolygoneFactory::createSpiral(Point &p, double R, double width, int precision, int nb_turns, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
...
Polygone *PolygoneFactory::createTower(Point &p, double R, double width, int precision, int layers, double alpha, double beta, double gama, const Color &color)
{
...
Polygone *PolygoneFactory::createTorus(Point &p, double R, double r, int precision, int layers, double alpha, double beta, double gama, const Color &color)
{
    std::vector<std::vector<Point*>> points;
...
Polygone *PolygoneFactory::createRing(Point &p, double R, double r, int precision, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
...
Polygone *PolygoneFactory::createCircle(Point &p, double R, int precision, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> points;
...
Polygone *PolygoneFactory::createStar(Point &p, double R, double r, double thick, int branch, double alpha, double beta, double gama, const Color &color)
{
    std::vector<Point*> sup_points;
    std::vector<Point*> inf_points;
